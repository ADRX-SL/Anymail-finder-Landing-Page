...
import { ANYMAIL_FINDER_REVIEW } from './constants';

const App: React.FC = () => {
  const content = ANYMAIL_FINDER_REVIEW;
  ...
  return (
    <Layout>
      ...
      {/* What is AnyMailFinder + Screenshot 1 */}
            ...
            <div className="w-full md:w-1/2">
              <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white p-2">
                <img 
                  ...
                  alt={`${content.competitorName} Dashboard`} 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} bulk search and verification dashboard.</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="w-full lg:w-1/2">
              <h2 className="text-4xl font-extrabold tracking-tight mb-8">Deliverability Benchmark</h2>
              <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-3 overflow-hidden">
                <img 
                  src={content.reviewScreenshot} 
                  alt={`${content.competitorName} Email Verification`} 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "The 'verified-only' charging model is the tool's biggest strength. It eliminates the guesswork common in other finders, ensuring your outreach is based on deliverable data, not just patterns."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 mb-12">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Email Bounce Rate</div>
                  <div className="text-2xl font-bold text-[#121212]">{content.accuracyData.email}</div>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Value Model</div>
                  <div className="text-2xl font-bold text-[#121212]">Pay-per-Verified Results</div>
                </div>
              </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">Single-purpose email finding</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Bulk enrichment & data management</td>
                </tr>
                <tr className="border-b border-gray-50">
                ...
                <tr className="border-b border-100">
                  ...
                  <td className="py-6 px-8 text-gray-500">No mobile phone data</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Multi-provider mobile enrichment</td>
                </tr>
              </tbody>
            </table>
          </div>
